...
//    }
    ...
    public List<AddressResponse> findAddressByCityAndDistrictAndContainName(String city, String district, String name) {
        return addressRepository.findAddressByCityAndDistrictAndContainName(city, district, name)
                .stream().map(addressMapper::toAddressResponse).toList();
    }
